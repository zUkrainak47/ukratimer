import { timer, State as TimerState } from './timer.js?v=2026061403';
...
import { connectGoogleDrive, consumeAuthSession, exportBackupToGoogleDrive, getGoogleDriveBackupInfo, hasGoogleDriveSession, importBackupFromGoogleDrive, isGoogleDriveSyncConfigured, restoreGoogleDriveSession, signOutOfGoogleDrive } from './google-drive-sync.js?v=2026061403';
import { dailyStreakStore, normalizeDailyStreakGoal } from './streaks.js?v=2026061403';
import { bluetoothTimerInput, BluetoothTimerState } from './hardware-bluetooth-timer.js?v=2026061403';
import { stackmatInput } from './hardware-stackmat.js?v=2026061403';
import { isHardwareTimeEntryMode, isTypingTimeEntryMode, normalizeTimeEntryMode, TIME_ENTRY_MODE_BLUETOOTH, TIME_ENTRY_MODE_STACKMAT, TIME_ENTRY_MODE_TIMER } from './time-entry.js?v=2026061403';
import { battleManager } from './battle.js?v=2026061403';
import { CHANGELOG_ENTRIES, LATEST_CHANGELOG_ENTRY_ID } from './changelog.js?v=2026061403';
...
async function registerServiceWorker() {
    ...
    try {
        const serviceWorkerUrl = new URL('../sw.js?v=2026061403', import.meta.url);
