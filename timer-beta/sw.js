const APP_CACHE_NAME = 'ukratimer-app-v2026042702';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042702';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042702',
    './css/fonts.css?v=2026042702',
    './css/variables.css?v=2026042702',
    './css/base.css?v=2026042702',
    './css/layout.css?v=2026042702',
    './css/scramble.css?v=2026042702',
    './css/timer.css?v=2026042702',
    './css/stats.css?v=2026042702',
    './css/cube.css?v=2026042702',
    './css/graph.css?v=2026042702',
    './css/modal.css?v=2026042702',
    './css/settings.css?v=2026042702',
    './js/app.js?v=2026042702',
    './js/timer.js?v=2026042702',
    './js/scramble.js?v=2026042702',
    './js/subset-scramblers.js?v=2026042702',
    './js/session.js?v=2026042702',
    './js/settings.js?v=2026042702',
    './js/stats.js?v=2026042702',
    './js/modal.js?v=2026042702',
    './js/time-entry.js?v=2026042702',
    './js/crypto-aes128.js?v=2026042702',
    './js/hardware-stackmat.js?v=2026042702',
    './js/hardware-bluetooth-timer.js?v=2026042702',
    './js/cube-display.js?v=2026042702',
    './js/graph.js?v=2026042702',
    './js/utils.js?v=2026042702',
    './js/storage.js?v=2026042702',
    './js/db.js?v=2026042702',
    './js/distribution.js?v=2026042702',
    './js/google-drive-sync.js?v=2026042702',
