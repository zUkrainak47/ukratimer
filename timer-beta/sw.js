const APP_CACHE_NAME = 'ukratimer-app-v2026051104';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026051104';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026051104',
    './css/fonts.css?v=2026051104',
    './css/variables.css?v=2026051104',
    './css/base.css?v=2026051104',
    './css/layout.css?v=2026051104',
    './css/scramble.css?v=2026051104',
    './css/timer.css?v=2026051104',
    './css/stats.css?v=2026051104',
    './css/cube.css?v=2026051104',
    './css/graph.css?v=2026051104',
    './css/modal.css?v=2026051104',
    './css/battle.css?v=2026051104',
    './css/settings.css?v=2026051104',
    './js/app.js?v=2026051104',
    './js/timer.js?v=2026051104',
    './js/scramble.js?v=2026051104',
    './js/subset-scramblers.js?v=2026051104',
    './js/session.js?v=2026051104',
    './js/settings.js?v=2026051104',
    './js/stats.js?v=2026051104',
    './js/modal.js?v=2026051104',
    './js/time-entry.js?v=2026051104',
    './js/crypto-aes128.js?v=2026051104',
    './js/hardware-stackmat.js?v=2026051104',
    './js/hardware-bluetooth-timer.js?v=2026051104',
    './js/cube-display.js?v=2026051104',
    './js/graph.js?v=2026051104',
    './js/utils.js?v=2026051104',
    './js/storage.js?v=2026051104',
    './js/db.js?v=2026051104',
    './js/distribution.js?v=2026051104',
    './js/battle.js?v=2026051104',
    './js/streaks.js?v=2026051104',
    './js/google-drive-sync.js?v=2026051104',
