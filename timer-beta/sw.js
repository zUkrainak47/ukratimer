const APP_CACHE_NAME = 'ukratimer-app-v2026052250';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026052250';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026052250',
    './css/fonts.css?v=2026052250',
    './css/variables.css?v=2026052250',
    './css/base.css?v=2026052250',
    './css/layout.css?v=2026052250',
    './css/scramble.css?v=2026052250',
    './css/timer.css?v=2026052250',
    './css/stats.css?v=2026052250',
    './css/cube.css?v=2026052250',
    './css/graph.css?v=2026052250',
    './css/modal.css?v=2026052250',
    './css/battle.css?v=2026052250',
    './css/settings.css?v=2026052250',
    './js/app.js?v=2026052250',
    './js/timer.js?v=2026052250',
    './js/scramble.js?v=2026052250',
    './js/subset-scramblers.js?v=2026052250',
    './js/session.js?v=2026052250',
    './js/setting-scopes.js?v=2026052250',
    './js/settings.js?v=2026052250',
    './js/stats.js?v=2026052250',
    './js/modal.js?v=2026052250',
    './js/time-entry.js?v=2026052250',
    './js/crypto-aes128.js?v=2026052250',
    './js/hardware-stackmat.js?v=2026052250',
    './js/hardware-bluetooth-timer.js?v=2026052250',
    './js/cube-display.js?v=2026052250',
    './js/graph.js?v=2026052250',
    './js/utils.js?v=2026052250',
    './js/storage.js?v=2026052250',
    './js/db.js?v=2026052250',
    './js/distribution.js?v=2026052250',
    './js/daily-streak-modal.js?v=2026052250',
    './js/battle.js?v=2026052250',
    './js/streaks.js?v=2026052250',
    './js/google-drive-sync.js?v=2026052250',
    './js/changelog.js?v=2026052250',
