const APP_CACHE_NAME = 'ukratimer-app-v2026052256';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026052256';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026052256',
    './css/fonts.css?v=2026052256',
    './css/variables.css?v=2026052256',
    './css/base.css?v=2026052256',
    './css/layout.css?v=2026052256',
    './css/scramble.css?v=2026052256',
    './css/timer.css?v=2026052256',
    './css/stats.css?v=2026052256',
    './css/cube.css?v=2026052256',
    './css/graph.css?v=2026052256',
    './css/modal.css?v=2026052256',
    './css/battle.css?v=2026052256',
    './css/settings.css?v=2026052256',
    './js/app.js?v=2026052256',
    './js/timer.js?v=2026052256',
    './js/scramble.js?v=2026052256',
    './js/subset-scramblers.js?v=2026052256',
    './js/session.js?v=2026052256',
    './js/setting-scopes.js?v=2026052256',
    './js/settings.js?v=2026052256',
    './js/stats.js?v=2026052256',
    './js/modal.js?v=2026052256',
    './js/time-entry.js?v=2026052256',
    './js/crypto-aes128.js?v=2026052256',
    './js/hardware-stackmat.js?v=2026052256',
    './js/hardware-bluetooth-timer.js?v=2026052256',
    './js/cube-display.js?v=2026052256',
    './js/graph.js?v=2026052256',
    './js/utils.js?v=2026052256',
    './js/storage.js?v=2026052256',
    './js/db.js?v=2026052256',
    './js/distribution.js?v=2026052256',
    './js/daily-streak-modal.js?v=2026052256',
    './js/battle.js?v=2026052256',
    './js/streaks.js?v=2026052256',
    './js/google-drive-sync.js?v=2026052256',
    './js/changelog.js?v=2026052256',
