const APP_CACHE_NAME = 'ukratimer-app-v2026042805';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042805';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042805',
    './css/fonts.css?v=2026042805',
    './css/variables.css?v=2026042805',
    './css/base.css?v=2026042805',
    './css/layout.css?v=2026042805',
    './css/scramble.css?v=2026042805',
    './css/timer.css?v=2026042805',
    './css/stats.css?v=2026042805',
    './css/cube.css?v=2026042805',
    './css/graph.css?v=2026042805',
    './css/modal.css?v=2026042805',
    './css/settings.css?v=2026042805',
    './js/app.js?v=2026042805',
    './js/timer.js?v=2026042805',
    './js/scramble.js?v=2026042805',
    './js/subset-scramblers.js?v=2026042805',
    './js/session.js?v=2026042805',
    './js/settings.js?v=2026042805',
    './js/stats.js?v=2026042805',
    './js/modal.js?v=2026042805',
    './js/time-entry.js?v=2026042805',
    './js/crypto-aes128.js?v=2026042805',
    './js/hardware-stackmat.js?v=2026042805',
    './js/hardware-bluetooth-timer.js?v=2026042805',
    './js/cube-display.js?v=2026042805',
    './js/graph.js?v=2026042805',
    './js/utils.js?v=2026042805',
    './js/storage.js?v=2026042805',
    './js/db.js?v=2026042805',
    './js/distribution.js?v=2026042805',
    './js/google-drive-sync.js?v=2026042805',
