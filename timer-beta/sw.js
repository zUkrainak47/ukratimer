...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026050801',
    './css/fonts.css?v=2026050801',
    './css/variables.css?v=2026050801',
    './css/base.css?v=2026050801',
    './css/layout.css?v=2026050801',
    './css/scramble.css?v=2026050801',
    './css/timer.css?v=2026050801',
    './css/stats.css?v=2026050801',
    ...
    './js/session.js?v=2026050801',
    './js/settings.js?v=2026050801',
    './js/stats.js?v=2026050801',
    './js/modal.js?v=2026050801',
    './js/time-entry.js?v=2026050801',
    './js/crypto-aes128.js?v=2026050801',
    './js/hardware-stackmat.js?v=2026050801',
    './js/hardware-bluetooth-timer.js?v=2026050801',
    './js/cube-display.js?v=2026050801',
    './js/graph.js?v=2026050801',
    './js/utils.js?v=2026050801',
    './js/storage.js?v=2026050801',
    './js/db.js?v=2026050801',
    './js/distribution.js?v=2026050801',
    './js/google-drive-sync.js?v=2026050801',
