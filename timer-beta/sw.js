const APP_CACHE_NAME = 'ukratimer-app-v2026043001';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026043001';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026043001',
    './css/fonts.css?v=2026043001',
    './css/variables.css?v=2026043001',
    './css/base.css?v=2026043001',
    './css/layout.css?v=2026043001',
    './css/scramble.css?v=2026043001',
    './css/timer.css?v=2026043001',
    './css/stats.css?v=2026043001',
    './css/cube.css?v=2026043001',
    './css/graph.css?v=2026043001',
    './css/modal.css?v=2026043001',
    './css/settings.css?v=2026043001',
    './js/app.js?v=2026043001',
    './js/timer.js?v=2026043001',
    './js/scramble.js?v=2026043001',
    './js/subset-scramblers.js?v=2026043001',
    './js/session.js?v=2026043001',
    './js/settings.js?v=2026043001',
    './js/stats.js?v=2026043001',
    './js/modal.js?v=2026043001',
    './js/time-entry.js?v=2026043001',
    './js/crypto-aes128.js?v=2026043001',
    './js/hardware-stackmat.js?v=2026043001',
    './js/hardware-bluetooth-timer.js?v=2026043001',
    './js/cube-display.js?v=2026043001',
    './js/graph.js?v=2026043001',
    './js/utils.js?v=2026043001',
    './js/storage.js?v=2026043001',
    './js/db.js?v=2026043001',
    './js/distribution.js?v=2026043001',
    './js/google-drive-sync.js?v=2026043001',
