...
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026050802';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026050802',
    './css/fonts.css?v=2026050802',
    './css/variables.css?v=2026050802',
    './css/base.css?v=2026050802',
    './css/layout.css?v=2026050802',
    './css/scramble.css?v=2026050802',
    './css/timer.css?v=2026050802',
    './css/stats.css?v=2026050802',
    './css/cube.css?v=2026050802',
    './css/graph.css?v=2026050802',
    './css/modal.css?v=2026050802',
    './css/battle.css?v=2026050802',
    './css/settings.css?v=2026050802',
    './js/app.js?v=2026050802',
    './js/timer.js?v=2026050802',
    './js/scramble.js?v=2026050802',
    './js/subset-scramblers.js?v=2026050802',
    './js/session.js?v=2026050802',
    './js/settings.js?v=2026050802',
    './js/stats.js?v=2026050802',
    './js/modal.js?v=2026050802',
    './js/time-entry.js?v=2026050802',
    './js/crypto-aes128.js?v=2026050802',
    './js/hardware-stackmat.js?v=2026050802',
    './js/hardware-bluetooth-timer.js?v=2026050802',
    './js/cube-display.js?v=2026050802',
    './js/graph.js?v=2026050802',
    './js/utils.js?v=2026050802',
    './js/storage.js?v=2026050802',
    './js/db.js?v=2026050802',
    './js/distribution.js?v=2026050802',
    './js/google-drive-sync.js?v=2026050802',
