const APP_CACHE_NAME = 'ukratimer-app-v2026063002';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026063002';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026063002',
    './css/fonts.css?v=2026063002',
    './css/variables.css?v=2026063002',
    './css/base.css?v=2026063002',
    './css/layout.css?v=2026063002',
    './css/scramble.css?v=2026063002',
    './css/timer.css?v=2026063002',
    './css/stats.css?v=2026063002',
    './css/cube.css?v=2026063002',
    './css/graph.css?v=2026063002',
    './css/modal.css?v=2026063002',
    './css/battle.css?v=2026063002',
    './css/settings.css?v=2026063002',
    './js/app.js?v=2026063002',
    './js/timer.js?v=2026063002',
    './js/scramble.js?v=2026063002',
    './js/subset-scramblers.js?v=2026063002',
    './js/session.js?v=2026063002',
    './js/setting-scopes.js?v=2026063002',
    './js/settings.js?v=2026063002',
    './js/stats.js?v=2026063002',
    './js/modal.js?v=2026063002',
    './js/time-entry.js?v=2026063002',
    './js/crypto-aes128.js?v=2026063002',
    './js/hardware-stackmat.js?v=2026063002',
    './js/hardware-bluetooth-timer.js?v=2026063002',
    './js/cube-display.js?v=2026063002',
    './js/graph.js?v=2026063002',
    './js/utils.js?v=2026063002',
    './js/storage.js?v=2026063002',
    './js/db.js?v=2026063002',
    './js/distribution.js?v=2026063002',
    './js/daily-streak-modal.js?v=2026063002',
    './js/battle.js?v=2026063002',
    './js/streaks.js?v=2026063002',
    './js/google-drive-sync.js?v=2026063002',
    './js/changelog.js?v=2026063002',
