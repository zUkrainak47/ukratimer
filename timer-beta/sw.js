const APP_CACHE_NAME = 'ukratimer-app-v2026042804';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042804';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042804',
    './css/fonts.css?v=2026042804',
    './css/variables.css?v=2026042804',
    './css/base.css?v=2026042804',
    './css/layout.css?v=2026042804',
    './css/scramble.css?v=2026042804',
    './css/timer.css?v=2026042804',
    './css/stats.css?v=2026042804',
    './css/cube.css?v=2026042804',
    './css/graph.css?v=2026042804',
    './css/modal.css?v=2026042804',
    './css/settings.css?v=2026042804',
    './js/app.js?v=2026042804',
    './js/timer.js?v=2026042804',
    './js/scramble.js?v=2026042804',
    './js/subset-scramblers.js?v=2026042804',
    './js/session.js?v=2026042804',
    './js/settings.js?v=2026042804',
    './js/stats.js?v=2026042804',
    './js/modal.js?v=2026042804',
    './js/time-entry.js?v=2026042804',
    './js/crypto-aes128.js?v=2026042804',
    './js/hardware-stackmat.js?v=2026042804',
    './js/hardware-bluetooth-timer.js?v=2026042804',
    './js/cube-display.js?v=2026042804',
    './js/graph.js?v=2026042804',
    './js/utils.js?v=2026042804',
    './js/storage.js?v=2026042804',
    './js/db.js?v=2026042804',
    './js/distribution.js?v=2026042804',
    './js/google-drive-sync.js?v=2026042804',
