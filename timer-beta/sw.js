const APP_CACHE_NAME = 'ukratimer-app-v2026060801';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026060801';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026060801',
    './css/fonts.css?v=2026060801',
    './css/variables.css?v=2026060801',
    './css/base.css?v=2026060801',
    './css/layout.css?v=2026060801',
    './css/scramble.css?v=2026060801',
    './css/timer.css?v=2026060801',
    './css/stats.css?v=2026060801',
    './css/cube.css?v=2026060801',
    './css/graph.css?v=2026060801',
    './css/modal.css?v=2026060801',
    './css/battle.css?v=2026060801',
    './css/settings.css?v=2026060801',
    './js/app.js?v=2026060801',
    './js/timer.js?v=2026060801',
    './js/scramble.js?v=2026060801',
    './js/subset-scramblers.js?v=2026060801',
    './js/session.js?v=2026060801',
    './js/setting-scopes.js?v=2026060801',
    './js/settings.js?v=2026060801',
    './js/stats.js?v=2026060801',
    './js/modal.js?v=2026060801',
    './js/time-entry.js?v=2026060801',
    './js/crypto-aes128.js?v=2026060801',
    './js/hardware-stackmat.js?v=2026060801',
    './js/hardware-bluetooth-timer.js?v=2026060801',
    './js/cube-display.js?v=2026060801',
    './js/graph.js?v=2026060801',
    './js/utils.js?v=2026060801',
    './js/storage.js?v=2026060801',
    './js/db.js?v=2026060801',
    './js/distribution.js?v=2026060801',
    './js/daily-streak-modal.js?v=2026060801',
    './js/battle.js?v=2026060801',
    './js/streaks.js?v=2026060801',
    './js/google-drive-sync.js?v=2026060801',
    './js/changelog.js?v=2026060801',
