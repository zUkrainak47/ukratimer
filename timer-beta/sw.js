const APP_CACHE_NAME = 'ukratimer-app-v2026060101';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026060101';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026060101',
    './css/fonts.css?v=2026060101',
    './css/variables.css?v=2026060101',
    './css/base.css?v=2026060101',
    './css/layout.css?v=2026060101',
    './css/scramble.css?v=2026060101',
    './css/timer.css?v=2026060101',
    './css/stats.css?v=2026060101',
    './css/cube.css?v=2026060101',
    './css/graph.css?v=2026060101',
    './css/modal.css?v=2026060101',
    './css/battle.css?v=2026060101',
    './css/settings.css?v=2026060101',
    './js/app.js?v=2026060101',
    './js/timer.js?v=2026060101',
    './js/scramble.js?v=2026060101',
    './js/subset-scramblers.js?v=2026060101',
    './js/session.js?v=2026060101',
    './js/setting-scopes.js?v=2026060101',
    './js/settings.js?v=2026060101',
    './js/stats.js?v=2026060101',
    './js/modal.js?v=2026060101',
    './js/time-entry.js?v=2026060101',
    './js/crypto-aes128.js?v=2026060101',
    './js/hardware-stackmat.js?v=2026060101',
    './js/hardware-bluetooth-timer.js?v=2026060101',
    './js/cube-display.js?v=2026060101',
    './js/graph.js?v=2026060101',
    './js/utils.js?v=2026060101',
    './js/storage.js?v=2026060101',
    './js/db.js?v=2026060101',
    './js/distribution.js?v=2026060101',
    './js/daily-streak-modal.js?v=2026060101',
    './js/battle.js?v=2026060101',
    './js/streaks.js?v=2026060101',
    './js/google-drive-sync.js?v=2026060101',
    './js/changelog.js?v=2026060101',
