const APP_CACHE_NAME = 'ukratimer-app-v2026042807';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042807';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042807',
    './css/fonts.css?v=2026042807',
    './css/variables.css?v=2026042807',
    './css/base.css?v=2026042807',
    './css/layout.css?v=2026042807',
    './css/scramble.css?v=2026042807',
    './css/timer.css?v=2026042807',
    './css/stats.css?v=2026042807',
    './css/cube.css?v=2026042807',
    './css/graph.css?v=2026042807',
    './css/modal.css?v=2026042807',
    './css/settings.css?v=2026042807',
    './js/app.js?v=2026042807',
    './js/timer.js?v=2026042807',
    './js/scramble.js?v=2026042807',
    './js/subset-scramblers.js?v=2026042807',
    './js/session.js?v=2026042807',
    './js/settings.js?v=2026042807',
    './js/stats.js?v=2026042807',
    './js/modal.js?v=2026042807',
    './js/time-entry.js?v=2026042807',
    './js/crypto-aes128.js?v=2026042807',
    './js/hardware-stackmat.js?v=2026042807',
    './js/hardware-bluetooth-timer.js?v=2026042807',
    './js/cube-display.js?v=2026042807',
    './js/graph.js?v=2026042807',
    './js/utils.js?v=2026042807',
    './js/storage.js?v=2026042807',
    './js/db.js?v=2026042807',
    './js/distribution.js?v=2026042807',
    './js/google-drive-sync.js?v=2026042807',
