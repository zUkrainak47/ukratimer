const APP_CACHE_NAME = 'ukratimer-app-v2026051902';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026051902';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026051902',
    './css/fonts.css?v=2026051902',
    './css/variables.css?v=2026051902',
    './css/base.css?v=2026051902',
    './css/layout.css?v=2026051902',
    './css/scramble.css?v=2026051902',
    './css/timer.css?v=2026051902',
    './css/stats.css?v=2026051902',
    './css/cube.css?v=2026051902',
    './css/graph.css?v=2026051902',
    './css/modal.css?v=2026051902',
    './css/battle.css?v=2026051902',
    './css/settings.css?v=2026051902',
    './js/app.js?v=2026051902',
    './js/timer.js?v=2026051902',
    './js/scramble.js?v=2026051902',
    './js/subset-scramblers.js?v=2026051902',
    './js/session.js?v=2026051902',
    './js/setting-scopes.js?v=2026051902',
    './js/settings.js?v=2026051902',
    './js/stats.js?v=2026051902',
    './js/modal.js?v=2026051902',
    './js/time-entry.js?v=2026051902',
    './js/crypto-aes128.js?v=2026051902',
    './js/hardware-stackmat.js?v=2026051902',
    './js/hardware-bluetooth-timer.js?v=2026051902',
    './js/cube-display.js?v=2026051902',
    './js/graph.js?v=2026051902',
    './js/utils.js?v=2026051902',
    './js/storage.js?v=2026051902',
    './js/db.js?v=2026051902',
    './js/distribution.js?v=2026051902',
    './js/battle.js?v=2026051902',
    './js/streaks.js?v=2026051902',
    './js/google-drive-sync.js?v=2026051902',
