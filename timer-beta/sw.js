const APP_CACHE_NAME = 'ukratimer-app-v2026061601';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026061601';
...
const LOCAL_PRECACHE_PATHS = [
    ...
    './css/fonts.css?v=2026061601',
    './css/variables.css?v=2026061601',
    './css/base.css?v=2026061601',
    './css/layout.css?v=2026061601',
    './css/scramble.css?v=2026061601',
    './css/timer.css?v=2026061601',
    './css/stats.css?v=2026061601',
    './css/cube.css?v=2026061601',
    './css/graph.css?v=2026061601',
    './css/modal.css?v=2026061601',
    './css/battle.css?v=2026061601',
    './css/settings.css?v=2026061601',
    './js/app.js?v=2026061601',
    './js/timer.js?v=2026061601',
    './js/scramble.js?v=2026061601',
    './js/subset-scramblers.js?v=2026061601',
    './js/session.js?v=2026061601',
    './js/setting-scopes.js?v=2026061601',
    './js/settings.js?v=2026061601',
    './js/stats.js?v=2026061601',
    './js/modal.js?v=2026061601',
    './js/time-entry.js?v=2026061601',
    './js/crypto-aes128.js?v=2026061601',
    './js/hardware-stackmat.js?v=2026061601',
    './js/hardware-bluetooth-timer.js?v=2026061601',
    './js/cube-display.js?v=2026061601',
    './js/graph.js?v=2026061601',
    './js/utils.js?v=2026061601',
    './js/storage.js?v=2026061601',
    './js/db.js?v=2026061601',
    './js/distribution.js?v=2026061601',
    './js/daily-streak-modal.js?v=2026061601',
    './js/battle.js?v=2026061601',
    './js/streaks.js?v=2026061601',
    './js/google-drive-sync.js?v=2026061601',
    './js/changelog.js?v=2026061601',
