const APP_CACHE_NAME = 'ukratimer-app-v2026061402';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026061402';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026061402',
    './css/fonts.css?v=2026061402',
    './css/variables.css?v=2026061402',
    './css/base.css?v=2026061402',
    './css/layout.css?v=2026061402',
    './css/scramble.css?v=2026061402',
    './css/timer.css?v=2026061402',
    './css/stats.css?v=2026061402',
    './css/cube.css?v=2026061402',
    './css/graph.css?v=2026061402',
    './css/modal.css?v=2026061402',
    './css/battle.css?v=2026061402',
    './css/settings.css?v=2026061402',
    './js/app.js?v=2026061402',
    './js/timer.js?v=2026061402',
    './js/scramble.js?v=2026061402',
    './js/subset-scramblers.js?v=2026061402',
    './js/session.js?v=2026061402',
    './js/setting-scopes.js?v=2026061402',
    './js/settings.js?v=2026061402',
    './js/stats.js?v=2026061402',
    './js/modal.js?v=2026061402',
    './js/time-entry.js?v=2026061402',
    './js/crypto-aes128.js?v=2026061402',
    './js/hardware-stackmat.js?v=2026061402',
    './js/hardware-bluetooth-timer.js?v=2026061402',
    './js/cube-display.js?v=2026061402',
    './js/graph.js?v=2026061402',
    './js/utils.js?v=2026061402',
    './js/storage.js?v=2026061402',
    './js/db.js?v=2026061402',
    './js/distribution.js?v=2026061402',
    './js/daily-streak-modal.js?v=2026061402',
    './js/battle.js?v=2026061402',
    './js/streaks.js?v=2026061402',
    './js/google-drive-sync.js?v=2026061402',
    './js/changelog.js?v=2026061402',
