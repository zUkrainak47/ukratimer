const APP_CACHE_NAME = 'ukratimer-app-v2026042704';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042704';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042704',
    './css/fonts.css?v=2026042704',
    './css/variables.css?v=2026042704',
    './css/base.css?v=2026042704',
    './css/layout.css?v=2026042704',
    './css/scramble.css?v=2026042704',
    './css/timer.css?v=2026042704',
    './css/stats.css?v=2026042704',
    './css/cube.css?v=2026042704',
    './css/graph.css?v=2026042704',
    './css/modal.css?v=2026042704',
    './css/settings.css?v=2026042704',
    './js/app.js?v=2026042704',
    './js/timer.js?v=2026042704',
    './js/scramble.js?v=2026042704',
    './js/subset-scramblers.js?v=2026042704',
    './js/session.js?v=2026042704',
    './js/settings.js?v=2026042704',
    './js/stats.js?v=2026042704',
    './js/modal.js?v=2026042704',
    './js/time-entry.js?v=2026042704',
    './js/crypto-aes128.js?v=2026042704',
    './js/hardware-stackmat.js?v=2026042704',
    './js/hardware-bluetooth-timer.js?v=2026042704',
    './js/cube-display.js?v=2026042704',
    './js/graph.js?v=2026042704',
    './js/utils.js?v=2026042704',
    './js/storage.js?v=2026042704',
    './js/db.js?v=2026042704',
    './js/distribution.js?v=2026042704',
    './js/google-drive-sync.js?v=2026042704',
