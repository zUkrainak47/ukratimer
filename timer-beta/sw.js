const APP_CACHE_NAME = 'ukratimer-app-v2026051904';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026051904';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026051904',
    './css/fonts.css?v=2026051904',
    './css/variables.css?v=2026051904',
    './css/base.css?v=2026051904',
    './css/layout.css?v=2026051904',
    './css/scramble.css?v=2026051904',
    './css/timer.css?v=2026051904',
    './css/stats.css?v=2026051904',
    './css/cube.css?v=2026051904',
    './css/graph.css?v=2026051904',
    './css/modal.css?v=2026051904',
    './css/battle.css?v=2026051904',
    './css/settings.css?v=2026051904',
    './js/app.js?v=2026051904',
    './js/timer.js?v=2026051904',
    './js/scramble.js?v=2026051904',
    './js/subset-scramblers.js?v=2026051904',
    './js/session.js?v=2026051904',
    './js/setting-scopes.js?v=2026051904',
    './js/settings.js?v=2026051904',
    './js/stats.js?v=2026051904',
    './js/modal.js?v=2026051904',
    './js/time-entry.js?v=2026051904',
    './js/crypto-aes128.js?v=2026051904',
    './js/hardware-stackmat.js?v=2026051904',
    './js/hardware-bluetooth-timer.js?v=2026051904',
    './js/cube-display.js?v=2026051904',
    './js/graph.js?v=2026051904',
    './js/utils.js?v=2026051904',
    './js/storage.js?v=2026051904',
    './js/db.js?v=2026051904',
    './js/distribution.js?v=2026051904',
    './js/battle.js?v=2026051904',
    './js/streaks.js?v=2026051904',
    './js/google-drive-sync.js?v=2026051904',
