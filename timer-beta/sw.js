const APP_CACHE_NAME = 'ukratimer-app-v2026052251';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026052251';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026052251',
    './css/fonts.css?v=2026052251',
    './css/variables.css?v=2026052251',
    './css/base.css?v=2026052251',
    './css/layout.css?v=2026052251',
    './css/scramble.css?v=2026052251',
    './css/timer.css?v=2026052251',
    './css/stats.css?v=2026052251',
    './css/cube.css?v=2026052251',
    './css/graph.css?v=2026052251',
    './css/modal.css?v=2026052251',
    './css/battle.css?v=2026052251',
    './css/settings.css?v=2026052251',
    './js/app.js?v=2026052251',
    './js/timer.js?v=2026052251',
    './js/scramble.js?v=2026052251',
    './js/subset-scramblers.js?v=2026052251',
    './js/session.js?v=2026052251',
    './js/setting-scopes.js?v=2026052251',
    './js/settings.js?v=2026052251',
    './js/stats.js?v=2026052251',
    './js/modal.js?v=2026052251',
    './js/time-entry.js?v=2026052251',
    './js/crypto-aes128.js?v=2026052251',
    './js/hardware-stackmat.js?v=2026052251',
    './js/hardware-bluetooth-timer.js?v=2026052251',
    './js/cube-display.js?v=2026052251',
    './js/graph.js?v=2026052251',
    './js/utils.js?v=2026052251',
    './js/storage.js?v=2026052251',
    './js/db.js?v=2026052251',
    './js/distribution.js?v=2026052251',
    './js/daily-streak-modal.js?v=2026052251',
    './js/battle.js?v=2026052251',
    './js/streaks.js?v=2026052251',
    './js/google-drive-sync.js?v=2026052251',
    './js/changelog.js?v=2026052251',
