const APP_CACHE_NAME = 'ukratimer-app-v2026051402';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026051402';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026051402',
    './css/fonts.css?v=2026051402',
    './css/variables.css?v=2026051402',
    './css/base.css?v=2026051402',
    './css/layout.css?v=2026051402',
    './css/scramble.css?v=2026051402',
    './css/timer.css?v=2026051402',
    './css/stats.css?v=2026051402',
    './css/cube.css?v=2026051402',
    './css/graph.css?v=2026051402',
    './css/modal.css?v=2026051402',
    './css/battle.css?v=2026051402',
    './css/settings.css?v=2026051402',
    './js/app.js?v=2026051402',
    './js/timer.js?v=2026051402',
    ...
    './js/time-entry.js?v=2026051402',
    './js/crypto-aes128.js?v=2026051402',
    './js/hardware-stackmat.js?v=2026051402',
    './js/hardware-bluetooth-timer.js?v=2026051402',
    './js/cube-display.js?v=2026051402',
    './js/graph.js?v=2026051402',
    './js/utils.js?v=2026051402',
    './js/storage.js?v=2026051402',
    './js/db.js?v=2026051402',
    './js/distribution.js?v=2026051402',
    './js/battle.js?v=2026051402',
    './js/streaks.js?v=2026051402',
    './js/google-drive-sync.js?v=2026051402',
