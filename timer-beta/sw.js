const APP_CACHE_NAME = 'ukratimer-app-v2026051401';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026051401';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026051401',
    './css/fonts.css?v=2026051401',
    './css/variables.css?v=2026051401',
    './css/base.css?v=2026051401',
    './css/layout.css?v=2026051401',
    './css/scramble.css?v=2026051401',
    './css/timer.css?v=2026051401',
    './css/stats.css?v=2026051401',
    './css/cube.css?v=2026051401',
    './css/graph.css?v=2026051401',
    './css/modal.css?v=2026051401',
    './css/battle.css?v=2026051401',
    './css/settings.css?v=2026051401',
    './js/app.js?v=2026051401',
    './js/timer.js?v=2026051401',
    './js/scramble.js?v=2026051401',
    './js/subset-scramblers.js?v=2026051401',
    './js/session.js?v=2026051401',
    './js/settings.js?v=2026051401',
    './js/stats.js?v=2026051401',
    './js/modal.js?v=2026051401',
    './js/time-entry.js?v=2026051401',
    './js/crypto-aes128.js?v=2026051401',
    './js/hardware-stackmat.js?v=2026051401',
    './js/hardware-bluetooth-timer.js?v=2026051401',
    './js/cube-display.js?v=2026051401',
    './js/graph.js?v=2026051401',
    './js/utils.js?v=2026051401',
    './js/storage.js?v=2026051401',
    './js/db.js?v=2026051401',
    './js/distribution.js?v=2026051401',
    './js/battle.js?v=2026051401',
    './js/streaks.js?v=2026051401',
    './js/google-drive-sync.js?v=2026051401',
