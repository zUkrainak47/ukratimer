const APP_CACHE_NAME = 'ukratimer-app-v2026060102';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026060102';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026060102',
    './css/fonts.css?v=2026060102',
    './css/variables.css?v=2026060102',
    './css/base.css?v=2026060102',
    './css/layout.css?v=2026060102',
    './css/scramble.css?v=2026060102',
    './css/timer.css?v=2026060102',
    './css/stats.css?v=2026060102',
    './css/cube.css?v=2026060102',
    './css/graph.css?v=2026060102',
    './css/modal.css?v=2026060102',
    './css/battle.css?v=2026060102',
    './css/settings.css?v=2026060102',
    './js/app.js?v=2026060102',
    './js/timer.js?v=2026060102',
    './js/scramble.js?v=2026060102',
    './js/subset-scramblers.js?v=2026060102',
    './js/session.js?v=2026060102',
    './js/setting-scopes.js?v=2026060102',
    './js/settings.js?v=2026060102',
    './js/stats.js?v=2026060102',
    './js/modal.js?v=2026060102',
    './js/time-entry.js?v=2026060102',
    './js/crypto-aes128.js?v=2026060102',
    './js/hardware-stackmat.js?v=2026060102',
    './js/hardware-bluetooth-timer.js?v=2026060102',
    './js/cube-display.js?v=2026060102',
    './js/graph.js?v=2026060102',
    './js/utils.js?v=2026060102',
    './js/storage.js?v=2026060102',
    './js/db.js?v=2026060102',
    './js/distribution.js?v=2026060102',
    './js/daily-streak-modal.js?v=2026060102',
    './js/battle.js?v=2026060102',
    './js/streaks.js?v=2026060102',
    './js/google-drive-sync.js?v=2026060102',
    './js/changelog.js?v=2026060102',
