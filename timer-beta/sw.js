const APP_CACHE_NAME = 'ukratimer-app-v2026042806';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042806';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042806',
    './css/fonts.css?v=2026042806',
    './css/variables.css?v=2026042806',
    './css/base.css?v=2026042806',
    './css/layout.css?v=2026042806',
    './css/scramble.css?v=2026042806',
    './css/timer.css?v=2026042806',
    './css/stats.css?v=2026042806',
    './css/cube.css?v=2026042806',
    './css/graph.css?v=2026042806',
    './css/modal.css?v=2026042806',
    './css/settings.css?v=2026042806',
    './js/app.js?v=2026042806',
    './js/timer.js?v=2026042806',
    './js/scramble.js?v=2026042806',
    './js/subset-scramblers.js?v=2026042806',
    './js/session.js?v=2026042806',
    './js/settings.js?v=2026042806',
    './js/stats.js?v=2026042806',
    './js/modal.js?v=2026042806',
    './js/time-entry.js?v=2026042806',
    './js/crypto-aes128.js?v=2026042806',
    './js/hardware-stackmat.js?v=2026042806',
    './js/hardware-bluetooth-timer.js?v=2026042806',
    './js/cube-display.js?v=2026042806',
    './js/graph.js?v=2026042806',
    './js/utils.js?v=2026042806',
    './js/storage.js?v=2026042806',
    './js/db.js?v=2026042806',
    './js/distribution.js?v=2026042806',
    './js/google-drive-sync.js?v=2026042806',
