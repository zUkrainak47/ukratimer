const APP_CACHE_NAME = 'ukratimer-app-v2026042803';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026042803';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026042803',
    './css/fonts.css?v=2026042803',
    './css/variables.css?v=2026042803',
    './css/base.css?v=2026042803',
    './css/layout.css?v=2026042803',
    './css/scramble.css?v=2026042803',
    './css/timer.css?v=2026042803',
    './css/stats.css?v=2026042803',
    './css/cube.css?v=2026042803',
    './css/graph.css?v=2026042803',
    './css/modal.css?v=2026042803',
    './css/settings.css?v=2026042803',
    './js/app.js?v=2026042803',
    './js/timer.js?v=2026042803',
    './js/scramble.js?v=2026042803',
    './js/subset-scramblers.js?v=2026042803',
    './js/session.js?v=2026042803',
    './js/settings.js?v=2026042803',
    './js/stats.js?v=2026042803',
    './js/modal.js?v=2026042803',
    './js/time-entry.js?v=2026042803',
    './js/crypto-aes128.js?v=2026042803',
    './js/hardware-stackmat.js?v=2026042803',
    './js/hardware-bluetooth-timer.js?v=2026042803',
    './js/cube-display.js?v=2026042803',
    './js/graph.js?v=2026042803',
    './js/utils.js?v=2026042803',
    './js/storage.js?v=2026042803',
    './js/db.js?v=2026042803',
    './js/distribution.js?v=2026042803',
    './js/google-drive-sync.js?v=2026042803',
