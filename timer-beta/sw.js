const APP_CACHE_NAME = 'ukratimer-app-v2026071401';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026071401';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026071401',
    './css/fonts.css?v=2026071401',
    './css/variables.css?v=2026071401',
    './css/base.css?v=2026071401',
    './css/layout.css?v=2026071401',
    './css/scramble.css?v=2026071401',
    './css/timer.css?v=2026071401',
    './css/stats.css?v=2026071401',
    './css/cube.css?v=2026071401',
    './css/graph.css?v=2026071401',
    './css/modal.css?v=2026071401',
    './css/battle.css?v=2026071401',
    './css/settings.css?v=2026071401',
    './js/app.js?v=2026071401',
    './js/timer.js?v=2026071401',
    './js/scramble.js?v=2026071401',
    './js/pll-cases.js?v=2026071401',
    './js/oll-cases.js?v=2026071401',
    './js/subset-scramblers.js?v=2026071401',
    './js/session.js?v=2026071401',
    './js/setting-scopes.js?v=2026071401',
    './js/settings.js?v=2026071401',
    './js/stats.js?v=2026071401',
    './js/modal.js?v=2026071401',
    './js/time-entry.js?v=2026071401',
    './js/crypto-aes128.js?v=2026071401',
    './js/hardware-stackmat.js?v=2026071401',
    './js/hardware-bluetooth-timer.js?v=2026071401',
    './js/cube-display.js?v=2026071401',
    './js/graph.js?v=2026071401',
    './js/utils.js?v=2026071401',
    './js/storage.js?v=2026071401',
    './js/cstimer-trainer-metadata.mjs?v=2026071401',
    './js/db.js?v=2026071401',
    './js/distribution.js?v=2026071401',
    './js/daily-streak-modal.js?v=2026071401',
    './js/battle.js?v=2026071401',
    './js/streaks.js?v=2026071401',
    './js/google-drive-sync.js?v=2026071401',
    './js/changelog.js?v=2026071401',
    ...
    './resources/distribution-cumulative.svg',
    './resources/distribution-normal.svg',
    './resources/fullscreen.svg',
    './resources/restore.svg',
    './resources/circle.svg',
    './resources/compress.svg',
    './resources/expand.svg',
    './resources/trending-down.svg',
    './resources/trash.svg',
