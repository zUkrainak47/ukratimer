const APP_CACHE_NAME = 'ukratimer-app-v2026061403';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026061403';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026061403',
    './css/fonts.css?v=2026061403',
    './css/variables.css?v=2026061403',
    './css/base.css?v=2026061403',
    './css/layout.css?v=2026061403',
    './css/scramble.css?v=2026061403',
    './css/timer.css?v=2026061403',
    './css/stats.css?v=2026061403',
    './css/cube.css?v=2026061403',
    './css/graph.css?v=2026061403',
    './css/modal.css?v=2026061403',
    './css/battle.css?v=2026061403',
    './css/settings.css?v=2026061403',
    './js/app.js?v=2026061403',
    './js/timer.js?v=2026061403',
    './js/scramble.js?v=2026061403',
    './js/subset-scramblers.js?v=2026061403',
    './js/session.js?v=2026061403',
    './js/setting-scopes.js?v=2026061403',
    './js/settings.js?v=2026061403',
    './js/stats.js?v=2026061403',
    './js/modal.js?v=2026061403',
    './js/time-entry.js?v=2026061403',
    './js/crypto-aes128.js?v=2026061403',
    './js/hardware-stackmat.js?v=2026061403',
    './js/hardware-bluetooth-timer.js?v=2026061403',
    './js/cube-display.js?v=2026061403',
    './js/graph.js?v=2026061403',
    './js/utils.js?v=2026061403',
    './js/storage.js?v=2026061403',
    './js/db.js?v=2026061403',
    './js/distribution.js?v=2026061403',
    './js/daily-streak-modal.js?v=2026061403',
    './js/battle.js?v=2026061403',
    './js/streaks.js?v=2026061403',
    './js/google-drive-sync.js?v=2026061403',
    './js/changelog.js?v=2026061403',
