const APP_CACHE_NAME = 'ukratimer-app-v2026080901';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026080901';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026080901',
    './css/fonts.css?v=2026080901',
    './css/variables.css?v=2026080901',
    './css/base.css?v=2026080901',
    './css/layout.css?v=2026080901',
    './css/scramble.css?v=2026080901',
    './css/timer.css?v=2026080901',
    './css/stats.css?v=2026080901',
    './css/cube.css?v=2026080901',
    './css/graph.css?v=2026080901',
    './css/modal.css?v=2026080901',
    './css/battle.css?v=2026080901',
    './css/settings.css?v=2026080901',
    './js/app.js?v=2026080901',
    './js/timer.js?v=2026080901',
    './js/scramble.js?v=2026080901',
    './js/pll-cases.js?v=2026080901',
    './js/oll-cases.js?v=2026080901',
    './js/subset-scramblers.js?v=2026080901',
    './js/session.js?v=2026080901',
    './js/setting-scopes.js?v=2026080901',
    './js/settings.js?v=2026080901',
    './js/stats.js?v=2026080901',
    './js/modal.js?v=2026080901',
    './js/time-entry.js?v=2026080901',
    './js/crypto-aes128.js?v=2026080901',
    './js/hardware-stackmat.js?v=2026080901',
    './js/hardware-bluetooth-timer.js?v=2026080901',
    './js/cube-display.js?v=2026080901',
    './js/graph.js?v=2026080901',
    './js/utils.js?v=2026080901',
    './js/storage.js?v=2026080901',
    './js/cstimer-trainer-metadata.mjs?v=2026080901',
    './js/db.js?v=2026080901',
    './js/distribution.js?v=2026080901',
    './js/daily-streak-modal.js?v=2026080901',
    './js/battle.js?v=2026080901',
    './js/streaks.js?v=2026080901',
    './js/google-drive-sync.js?v=2026080901',
    './js/changelog.js?v=2026080901',
