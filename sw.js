const APP_CACHE_NAME = 'ukratimer-app-v2026061301';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026061301';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026061301',
    './css/fonts.css?v=2026061301',
    './css/variables.css?v=2026061301',
    './css/base.css?v=2026061301',
    './css/layout.css?v=2026061301',
    './css/scramble.css?v=2026061301',
    './css/timer.css?v=2026061301',
    './css/stats.css?v=2026061301',
    './css/cube.css?v=2026061301',
    './css/graph.css?v=2026061301',
    './css/modal.css?v=2026061301',
    './css/battle.css?v=2026061301',
    './css/settings.css?v=2026061301',
    './js/app.js?v=2026061301',
    './js/timer.js?v=2026061301',
    './js/scramble.js?v=2026061301',
    './js/subset-scramblers.js?v=2026061301',
    './js/session.js?v=2026061301',
    './js/setting-scopes.js?v=2026061301',
    './js/settings.js?v=2026061301',
    './js/stats.js?v=2026061301',
    './js/modal.js?v=2026061301',
    './js/time-entry.js?v=2026061301',
    './js/crypto-aes128.js?v=2026061301',
    './js/hardware-stackmat.js?v=2026061301',
    './js/hardware-bluetooth-timer.js?v=2026061301',
    './js/cube-display.js?v=2026061301',
    './js/graph.js?v=2026061301',
    './js/utils.js?v=2026061301',
    './js/storage.js?v=2026061301',
    './js/db.js?v=2026061301',
    './js/distribution.js?v=2026061301',
    './js/daily-streak-modal.js?v=2026061301',
    './js/battle.js?v=2026061301',
    './js/streaks.js?v=2026061301',
    './js/google-drive-sync.js?v=2026061301',
    './js/changelog.js?v=2026061301',
