const APP_CACHE_NAME = 'ukratimer-app-v2026052101';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026052101';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026052101',
    './css/fonts.css?v=2026052101',
    './css/variables.css?v=2026052101',
    './css/base.css?v=2026052101',
    './css/layout.css?v=2026052101',
    './css/scramble.css?v=2026052101',
    './css/timer.css?v=2026052101',
    './css/stats.css?v=2026052101',
    './css/cube.css?v=2026052101',
    './css/graph.css?v=2026052101',
    './css/modal.css?v=2026052101',
    './css/battle.css?v=2026052101',
    './css/settings.css?v=2026052101',
    './js/app.js?v=2026052101',
    './js/timer.js?v=2026052101',
    './js/scramble.js?v=2026052101',
    './js/subset-scramblers.js?v=2026052101',
    './js/session.js?v=2026052101',
    './js/setting-scopes.js?v=2026052101',
    './js/settings.js?v=2026052101',
    './js/stats.js?v=2026052101',
    './js/modal.js?v=2026052101',
    './js/time-entry.js?v=2026052101',
    './js/crypto-aes128.js?v=2026052101',
    './js/hardware-stackmat.js?v=2026052101',
    './js/hardware-bluetooth-timer.js?v=2026052101',
    './js/cube-display.js?v=2026052101',
    './js/graph.js?v=2026052101',
    './js/utils.js?v=2026052101',
    './js/storage.js?v=2026052101',
    './js/db.js?v=2026052101',
    './js/distribution.js?v=2026052101',
    './js/battle.js?v=2026052101',
    './js/streaks.js?v=2026052101',
    './js/google-drive-sync.js?v=2026052101',
    './js/changelog.js?v=2026052101',
