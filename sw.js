const APP_CACHE_NAME = 'ukratimer-app-v2026060602';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026060602';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026060602',
    './css/fonts.css?v=2026060602',
    './css/variables.css?v=2026060602',
    './css/base.css?v=2026060602',
    './css/layout.css?v=2026060602',
    './css/scramble.css?v=2026060602',
    './css/timer.css?v=2026060602',
    './css/stats.css?v=2026060602',
    './css/cube.css?v=2026060602',
    './css/graph.css?v=2026060602',
    './css/modal.css?v=2026060602',
    './css/battle.css?v=2026060602',
    './css/settings.css?v=2026060602',
    './js/app.js?v=2026060602',
    './js/timer.js?v=2026060602',
    './js/scramble.js?v=2026060602',
    './js/subset-scramblers.js?v=2026060602',
    './js/session.js?v=2026060602',
    './js/setting-scopes.js?v=2026060602',
    './js/settings.js?v=2026060602',
    './js/stats.js?v=2026060602',
    './js/modal.js?v=2026060602',
    './js/time-entry.js?v=2026060602',
    './js/crypto-aes128.js?v=2026060602',
    './js/hardware-stackmat.js?v=2026060602',
    './js/hardware-bluetooth-timer.js?v=2026060602',
    './js/cube-display.js?v=2026060602',
    './js/graph.js?v=2026060602',
    './js/utils.js?v=2026060602',
    './js/storage.js?v=2026060602',
    './js/db.js?v=2026060602',
    './js/distribution.js?v=2026060602',
    './js/daily-streak-modal.js?v=2026060602',
    './js/battle.js?v=2026060602',
    './js/streaks.js?v=2026060602',
    './js/google-drive-sync.js?v=2026060602',
    './js/changelog.js?v=2026060602',
