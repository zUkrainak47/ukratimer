const APP_CACHE_NAME = 'ukratimer-app-v2026051202';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026051202';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026051202',
    './css/fonts.css?v=2026051202',
    './css/variables.css?v=2026051202',
    './css/base.css?v=2026051202',
    './css/layout.css?v=2026051202',
    './css/scramble.css?v=2026051202',
    './css/timer.css?v=2026051202',
    './css/stats.css?v=2026051202',
    './css/cube.css?v=2026051202',
    './css/graph.css?v=2026051202',
    './css/modal.css?v=2026051202',
    './css/battle.css?v=2026051202',
    './css/settings.css?v=2026051202',
    './js/app.js?v=2026051202',
    './js/timer.js?v=2026051202',
    './js/scramble.js?v=2026051202',
    './js/subset-scramblers.js?v=2026051202',
    './js/session.js?v=2026051202',
    './js/settings.js?v=2026051202',
    './js/stats.js?v=2026051202',
    './js/modal.js?v=2026051202',
    './js/time-entry.js?v=2026051202',
    './js/crypto-aes128.js?v=2026051202',
    './js/hardware-stackmat.js?v=2026051202',
    './js/hardware-bluetooth-timer.js?v=2026051202',
    './js/cube-display.js?v=2026051202',
    './js/graph.js?v=2026051202',
    './js/utils.js?v=2026051202',
    './js/storage.js?v=2026051202',
    './js/db.js?v=2026051202',
    './js/distribution.js?v=2026051202',
    './js/battle.js?v=2026051202',
    './js/streaks.js?v=2026051202',
    './js/google-drive-sync.js?v=2026051202',
