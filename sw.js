const APP_CACHE_NAME = 'ukratimer-app-v2026061501';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026061501';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026061501',
    './css/fonts.css?v=2026061501',
    './css/variables.css?v=2026061501',
    './css/base.css?v=2026061501',
    './css/layout.css?v=2026061501',
    './css/scramble.css?v=2026061501',
    './css/timer.css?v=2026061501',
    './css/stats.css?v=2026061501',
    './css/cube.css?v=2026061501',
    './css/graph.css?v=2026061501',
    './css/modal.css?v=2026061501',
    './css/battle.css?v=2026061501',
    './css/settings.css?v=2026061501',
    './js/app.js?v=2026061501',
    './js/timer.js?v=2026061501',
    './js/scramble.js?v=2026061501',
    './js/subset-scramblers.js?v=2026061501',
    './js/session.js?v=2026061501',
    './js/setting-scopes.js?v=2026061501',
    './js/settings.js?v=2026061501',
    './js/stats.js?v=2026061501',
    './js/modal.js?v=2026061501',
    './js/time-entry.js?v=2026061501',
    './js/crypto-aes128.js?v=2026061501',
    './js/hardware-stackmat.js?v=2026061501',
    './js/hardware-bluetooth-timer.js?v=2026061501',
    './js/cube-display.js?v=2026061501',
    './js/graph.js?v=2026061501',
    './js/utils.js?v=2026061501',
    './js/storage.js?v=2026061501',
    './js/db.js?v=2026061501',
    './js/distribution.js?v=2026061501',
    './js/daily-streak-modal.js?v=2026061501',
    './js/battle.js?v=2026061501',
    './js/streaks.js?v=2026061501',
    './js/google-drive-sync.js?v=2026061501',
    './js/changelog.js?v=2026061501',
