const APP_CACHE_NAME = 'ukratimer-app-v2026060701';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026060701';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026060701',
    './css/fonts.css?v=2026060701',
    './css/variables.css?v=2026060701',
    './css/base.css?v=2026060701',
    './css/layout.css?v=2026060701',
    './css/scramble.css?v=2026060701',
    './css/timer.css?v=2026060701',
    './css/stats.css?v=2026060701',
    './css/cube.css?v=2026060701',
    './css/graph.css?v=2026060701',
    './css/modal.css?v=2026060701',
    './css/battle.css?v=2026060701',
    './css/settings.css?v=2026060701',
    './js/app.js?v=2026060701',
    './js/timer.js?v=2026060701',
    './js/scramble.js?v=2026060701',
    './js/subset-scramblers.js?v=2026060701',
    './js/session.js?v=2026060701',
    './js/setting-scopes.js?v=2026060701',
    './js/settings.js?v=2026060701',
    './js/stats.js?v=2026060701',
    './js/modal.js?v=2026060701',
    './js/time-entry.js?v=2026060701',
    './js/crypto-aes128.js?v=2026060701',
    './js/hardware-stackmat.js?v=2026060701',
    './js/hardware-bluetooth-timer.js?v=2026060701',
    './js/cube-display.js?v=2026060701',
    './js/graph.js?v=2026060701',
    './js/utils.js?v=2026060701',
    './js/storage.js?v=2026060701',
    './js/db.js?v=2026060701',
    './js/distribution.js?v=2026060701',
    './js/daily-streak-modal.js?v=2026060701',
    './js/battle.js?v=2026060701',
    './js/streaks.js?v=2026060701',
    './js/google-drive-sync.js?v=2026060701',
    './js/changelog.js?v=2026060701',
