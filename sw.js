const APP_CACHE_NAME = 'ukratimer-app-v2026051203';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026051203';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026051203',
    './css/fonts.css?v=2026051203',
    './css/variables.css?v=2026051203',
    './css/base.css?v=2026051203',
    './css/layout.css?v=2026051203',
    './css/scramble.css?v=2026051203',
    './css/timer.css?v=2026051203',
    './css/stats.css?v=2026051203',
    './css/cube.css?v=2026051203',
    './css/graph.css?v=2026051203',
    './css/modal.css?v=2026051203',
    './css/battle.css?v=2026051203',
    './css/settings.css?v=2026051203',
    './js/app.js?v=2026051203',
    './js/timer.js?v=2026051203',
    './js/scramble.js?v=2026051203',
    './js/subset-scramblers.js?v=2026051203',
    './js/session.js?v=2026051203',
    './js/settings.js?v=2026051203',
    './js/stats.js?v=2026051203',
    './js/modal.js?v=2026051203',
    './js/time-entry.js?v=2026051203',
    './js/crypto-aes128.js?v=2026051203',
    './js/hardware-stackmat.js?v=2026051203',
    './js/hardware-bluetooth-timer.js?v=2026051203',
    './js/cube-display.js?v=2026051203',
    './js/graph.js?v=2026051203',
    './js/utils.js?v=2026051203',
    './js/storage.js?v=2026051203',
    './js/db.js?v=2026051203',
    './js/distribution.js?v=2026051203',
    './js/battle.js?v=2026051203',
    './js/streaks.js?v=2026051203',
    './js/google-drive-sync.js?v=2026051203',
