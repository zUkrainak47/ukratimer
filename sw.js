const APP_CACHE_NAME = 'ukratimer-app-v2026063003';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026063003';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026063003',
    './css/fonts.css?v=2026063003',
    './css/variables.css?v=2026063003',
    './css/base.css?v=2026063003',
    './css/layout.css?v=2026063003',
    './css/scramble.css?v=2026063003',
    './css/timer.css?v=2026063003',
    './css/stats.css?v=2026063003',
    './css/cube.css?v=2026063003',
    './css/graph.css?v=2026063003',
    './css/modal.css?v=2026063003',
    './css/battle.css?v=2026063003',
    './css/settings.css?v=2026063003',
    './js/app.js?v=2026063003',
    './js/timer.js?v=2026063003',
    './js/scramble.js?v=2026063003',
    './js/subset-scramblers.js?v=2026063003',
    './js/session.js?v=2026063003',
    './js/setting-scopes.js?v=2026063003',
    './js/settings.js?v=2026063003',
    './js/stats.js?v=2026063003',
    './js/modal.js?v=2026063003',
    './js/time-entry.js?v=2026063003',
    './js/crypto-aes128.js?v=2026063003',
    './js/hardware-stackmat.js?v=2026063003',
    './js/hardware-bluetooth-timer.js?v=2026063003',
    './js/cube-display.js?v=2026063003',
    './js/graph.js?v=2026063003',
    './js/utils.js?v=2026063003',
    './js/storage.js?v=2026063003',
    './js/db.js?v=2026063003',
    './js/distribution.js?v=2026063003',
    './js/daily-streak-modal.js?v=2026063003',
    './js/battle.js?v=2026063003',
    './js/streaks.js?v=2026063003',
    './js/google-drive-sync.js?v=2026063003',
    './js/changelog.js?v=2026063003',
