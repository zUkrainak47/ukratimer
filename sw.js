const APP_CACHE_NAME = 'ukratimer-app-v2026052201';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026052201';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026052201',
    './css/fonts.css?v=2026052201',
    './css/variables.css?v=2026052201',
    './css/base.css?v=2026052201',
    './css/layout.css?v=2026052201',
    './css/scramble.css?v=2026052201',
    './css/timer.css?v=2026052201',
    './css/stats.css?v=2026052201',
    './css/cube.css?v=2026052201',
    './css/graph.css?v=2026052201',
    './css/modal.css?v=2026052201',
    './css/battle.css?v=2026052201',
    './css/settings.css?v=2026052201',
    './js/app.js?v=2026052201',
    './js/timer.js?v=2026052201',
    './js/scramble.js?v=2026052201',
    './js/subset-scramblers.js?v=2026052201',
    './js/session.js?v=2026052201',
    './js/setting-scopes.js?v=2026052201',
    './js/settings.js?v=2026052201',
    './js/stats.js?v=2026052201',
    './js/modal.js?v=2026052201',
    './js/time-entry.js?v=2026052201',
    './js/crypto-aes128.js?v=2026052201',
    './js/hardware-stackmat.js?v=2026052201',
    './js/hardware-bluetooth-timer.js?v=2026052201',
    './js/cube-display.js?v=2026052201',
    './js/graph.js?v=2026052201',
    './js/utils.js?v=2026052201',
    './js/storage.js?v=2026052201',
    './js/db.js?v=2026052201',
    './js/distribution.js?v=2026052201',
    './js/battle.js?v=2026052201',
    './js/streaks.js?v=2026052201',
    './js/google-drive-sync.js?v=2026052201',
    './js/changelog.js?v=2026052201',
