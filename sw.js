const APP_CACHE_NAME = 'ukratimer-app-v2026060901';
const RUNTIME_CACHE_NAME = 'ukratimer-runtime-v2026060901';
...
const LOCAL_PRECACHE_PATHS = [
    './',
    './index.html',
    './manifest.webmanifest?v=2026060901',
    './css/fonts.css?v=2026060901',
    './css/variables.css?v=2026060901',
    './css/base.css?v=2026060901',
    './css/layout.css?v=2026060901',
    './css/scramble.css?v=2026060901',
    './css/timer.css?v=2026060901',
    './css/stats.css?v=2026060901',
    './css/cube.css?v=2026060901',
    './css/graph.css?v=2026060901',
    './css/modal.css?v=2026060901',
    './css/battle.css?v=2026060901',
    './css/settings.css?v=2026060901',
    './js/app.js?v=2026060901',
    './js/timer.js?v=2026060901',
    './js/scramble.js?v=2026060901',
    './js/subset-scramblers.js?v=2026060901',
    './js/session.js?v=2026060901',
    './js/setting-scopes.js?v=2026060901',
    './js/settings.js?v=2026060901',
    './js/stats.js?v=2026060901',
    './js/modal.js?v=2026060901',
    './js/time-entry.js?v=2026060901',
    './js/crypto-aes128.js?v=2026060901',
    './js/hardware-stackmat.js?v=2026060901',
    './js/hardware-bluetooth-timer.js?v=2026060901',
    './js/cube-display.js?v=2026060901',
    './js/graph.js?v=2026060901',
    './js/utils.js?v=2026060901',
    './js/storage.js?v=2026060901',
    './js/db.js?v=2026060901',
    './js/distribution.js?v=2026060901',
    './js/daily-streak-modal.js?v=2026060901',
    './js/battle.js?v=2026060901',
    './js/streaks.js?v=2026060901',
    './js/google-drive-sync.js?v=2026060901',
    './js/changelog.js?v=2026060901',
